...
const UpdateTask =({state})=>{
    ...
    const updateTask=async(event)=>{
        ...
        try{
          ...
          //agar hme data write or send krna hai on blockchain per using frontend then we are use this syntax
          //....isme hme vo account pass krna pdega jha data send krna hai send me ye syntax hai
          if(data.status===200)
          {
